...
class Paypal {
    ...
    {
        #Account information
        $config["business"]     = 'nil2take1-facilitator@gmail.com'; //Your PayPal account
        ...
        $config['base_url'] = 'http://localhost/smartbazaar/';
        $config["return"]           = $config['base_url'].'success'; //The URL to which PayPal redirects buyers’ browser after they complete their payments.
        $config["cancel_return"]    = $config['base_url'].'cancel'; //Specify a URL on your website that displays a “Payment Canceled” page.
