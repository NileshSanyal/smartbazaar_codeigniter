...
$config['protocol']         = 'smtp';    // changed               // 'mail', 'sendmail', or 'smtp'
$config['mailpath']         = '/usr/sbin/sendmail';
$config['smtp_host']        = 'smtp.gmail.com';
$config['smtp_user']        = 'nileshsanyal979@gmail.com'; // changed
$config['smtp_pass']        = 'backDoorDeveloper3#'; // changed
$config['smtp_port']        = 465; // changed
$config['smtp_timeout']     = 30;                       // (in seconds)
$config['smtp_crypto']      = 'ssl';       // changed                 // '' or 'tls' or 'ssl'
