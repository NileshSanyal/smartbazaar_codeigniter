<?php 
	...
	$usersessiondata = $CI->session->userdata('loginuserdata'); 
	$admin_assets = $CI->config->item('admin_assets');
?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							<li ><a href="<?php echo base_url(); ?>" class="hyper "><span>Home</span></a></li>	
									...
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												...
												?>
												<li><a href="kitchen.html"><i class="fa fa-angle-right" aria-hidden="true"></i><?php echo $cat->cat_name; ?></a></li>
												<?php 
														}
													}
...
<div class="modal fade" id="forgotPassModal" role="dialog">
	<div class="modal-dialog">
	  <div class="modal-content" style="width: 65%;margin: 0 auto;height: 272px;">
	    <div class="modal-header">
	      <button type="button" class="close" data-dismiss="modal">&times;</button>
	      <h4 class="modal-title">
	      	<div class="alert alert-danger" id="forgotPassErr" style="display: none;"></div>
	      </h4>
	    </div>
	    <div class="modal-body">
	    	<img id="loader" src="<?php echo $frontend_assets; ?>images/email_send_loader.gif" style="display:none;margin-top: -23px;margin-left: 200px;" height="60" width="60" class="img-head" alt="">
	    	<div class="form-w3agile form1">
		      	<form action="" method="post" name="forgotPassFrm" id="forgotPassFrm">
					<label for="forgotpassemail">Email</label>
					<div class="key">
						<i class="fa fa-envelope" aria-hidden="true"></i>
						<input  type="text" value="" name="forgotpassemail" id="forgotpassemail">
						<div class="clearfix"></div>
					</div>
					<input type="submit" value="Send Email" id="forgotPassBtn">
				</form>
			</div>
	    </div>
	  </div>
	...
	<div class="login">
		...
		<div class="main-agileits">
				<div class="form-w3agile">
					<h3>Login</h3>
					<div class="alert alert-danger" id="loginErr" style="display: none;"></div>
					<div class="alert alert-success" id="infoMsg" style="display: none;"></div>
					<form action="" method="post" name="userloginfrm" id="userloginfrm">
						<label for="loginmail">Email</label>
						<div class="key">
							<i class="fa fa-envelope" aria-hidden="true"></i>
							<input  type="text" value="" name="loginmail" id="loginmail">
							<div class="clearfix"></div>
						</div>
				...
				<div class="forg">
					<a data-toggle="modal" data-target="#forgotPassModal" href="javascript:void(0);" class="forg-left">Forgot Password</a>
					<a href="<?php echo base_url('register'); ?>" class="forg-right">Register</a>
				<div class="clearfix"></div>
				</div>
			</div>
		</div>
...
<!-- //for bootstrap working -->
<script type='text/javascript' src="<?php echo $frontend_assets; ?>js/jquery.mycart.js"></script>
