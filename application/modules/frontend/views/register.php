...
<html>
<head>
<title>Smart Bazaar | Register</title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
	<div class="container">
		<h3 >Register</h3>
		<h4><a href="<?php echo base_url(); ?>">Home</a><label>/</label>Register</h4>
		<div class="clearfix"> </div>
	</div>
</div>
	...
	<div class="login">
		<div class="main-agileits">
				<div class="form-w3agile form1">
				    ...
				    <?php }?>
					<!-- end -->
					<form action="" method="post" name="userregister" id="userregister">
						<div class="alert alert-danger" id="signuperr" style="display: none;"></div>
						...
						<div class="key">
							...
							<input  type="text" value="" name="mobilenum" id="mobilenum">
							<div class="clearfix"></div>
						</div>
